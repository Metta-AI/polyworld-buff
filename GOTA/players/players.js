...
function groupsFor(data) {
  return [
    ...
    {id: 'direct', title: 'Direct control', image: 'attack', rows: [
      ...
      share('target_tower', 'Attacks targeting towers', 'tower', 'Share of accepted attack-target orders aimed at towers. Games without an accepted attack-target order are excluded.'),
      share('target_barracks', 'Attacks targeting barracks', 'fort', 'Share of accepted attack-target orders aimed at barracks. Games without an accepted attack-target order are excluded.'),
    ...
    {id: 'indirect', title: 'Indirect statistics', image: 'gold', rows: [
      ...
      metric('gold_neutral', 'Gold from neutrals', 'gold', 'per game', 'number', 'Gold credited from neutral camp kills. Included in total gold earned.'),
    ...
    {id: 'downstream', title: 'Downstream statistics', image: 'victory', rows: [
      ...
      metric('xp_lasthit', 'XP from creep last hits', 'minion', 'per game', 'number', 'XP credited to the last hitter of lane creeps or neutral camp creatures. Includes XP from neutral last hits below.'),
      metric('xp_neutral_lasthit', 'XP from neutral last hits', 'minion', 'per game', 'number', 'XP credited to the last hitter of neutral camp creatures. This is a subset of XP from creep last hits.'),
      metric('xp_shared', 'XP from nearby creep deaths', 'experience', 'per game', 'number', 'Shared XP from nearby lane creep or neutral camp deaths. Includes XP from nearby neutral deaths below.'),
      metric('xp_neutral_shared', 'XP from nearby neutral deaths', 'experience', 'per game', 'number', 'Shared XP from nearby neutral camp deaths without landing the last hit. This is a subset of XP from nearby creep deaths.'),
      metric('xp_herokill', 'XP from hero kills', 'kills'),
      metric('xp_tower', 'XP from towers', 'tower'),
      metric('xp_barracks', 'XP from barracks', 'fort'),
      metric('xp_god', 'XP from the god', 'fort'),
      metric('kills', 'Hero kills', 'kills'), metric('assists', 'Assists', 'attack'),
      metric('neutral_kills', 'Neutral kills', 'minion', 'per game', 'number', 'Neutral camp creatures killed by this hero. Counts individual creatures, not completed camps.'),
      metric('deaths', 'Deaths', 'damage'),
